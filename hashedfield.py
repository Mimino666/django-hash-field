...
class HashedField(models.CharField):
    description = ('HashedField is related to some other field in a model and'
    ...
    def __init__(self, original, *args, **kwargs):
        ...
        super(HashedField, self).__init__(*args, **kwargs)
    ...
    def pre_save(self, model_instance, add):
        ...
        return super(HashedField, self).pre_save(model_instance, add)
...
["^myproject\.fields\.HashedField"])  # use your own path to HashedField
